...
# # train Teresa with the neutral training data
# # validate for different hidden units
...
# # find improv player parameter set: which self-excitation is far enough from standard, which h/t maybe produces another slope in the line plot so that match difference is bigger than no match high confidence difference 
